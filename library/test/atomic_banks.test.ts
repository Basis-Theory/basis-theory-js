...
import { Bank, CreateAtomicBankModel } from '../src/atomic/bank/types';
...
describe('Atomic Banks', () => {
  ...
  describe('create, retrieve, delete', () => {
    const createPayload = {
      bank: {
        routing_number: chance.string(),
        account_number: chance.string(),
      } as Bank,
      metadata: {
        test: chance.string(),
      },
    } as CreateAtomicBankModel;
